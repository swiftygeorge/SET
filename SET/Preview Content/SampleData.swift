...
struct SampleData {
    static let diamondOne = Card(mainSymbol: .diamond, mainSymbolCount: 1, mainColor: .mainGreen, mainOpacity: .transparent, hasBeenDealt: true)
    static let diamondTwo = Card(mainSymbol: .diamond, mainSymbolCount: 2, mainColor: .mainGreen, mainOpacity: .translucent, hasBeenDealt: true)
    static let diamondThree = Card(mainSymbol: .diamond, mainSymbolCount: 3, mainColor: .mainGreen, mainOpacity: .opaque, hasBeenDealt: true)
